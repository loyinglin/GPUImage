...
//
        ...
        if ([dicPerson objectForKey:RECT_KEY]) {
            ...
            //NSLog(@"dicPerson [%@]", [dicPerson objectForKey:RECT_ORI]);
...
//            }
            ...
            if(self.headMap){
               ...
               // CGRect frame = CGRectMake(rect.origin.x- ((headMapViewW - rect.size.width) * 0.5), rect.origin.y - headmapViewH, headMapViewW, headmapViewH);
               ...
               // NSLog(@"%f",rotation);
                ...
                //self.headMapView.transform = CGAffineTransformRotate(transform, -rotation);
